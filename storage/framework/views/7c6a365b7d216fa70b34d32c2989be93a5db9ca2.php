                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="ir_w_25"><?php echo app('translator')->get('index.name'); ?></th>
                                <th class="ir_w_16"><?php echo app('translator')->get('index.description'); ?></th>
                                <th class="ir_w_1 ir_txt_center not-export-col"><?php echo app('translator')->get('index.actions'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="ir_txt_center">
                                        ...
                                        <?php endif; ?>
                                        <?php if(routePermission('rmcategory.delete')): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\rmcategory\rmcategories.blade.php ENDPATH**/ ?>