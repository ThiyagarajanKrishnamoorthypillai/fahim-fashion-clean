    ...
    <div class="m-auto b-r-5 p-30">
            ...
            <tr>
                ...
                <td class="w-50 text-right">
                    ...
                    <?php if(isset($obj->expiry_days) && !empty($obj->expiry_days)): ?>
                        <p class="pb-7 rgb-71">
                            <span class=""><?php echo app('translator')->get('index.expiry_days'); ?>:</span>
        ...
        <table class="w-100 mt-10">
            <thead class="b-r-3 bg-color-000000">
                <tr>
                    ...
                    <th class="w-30 text-left"><?php echo app('translator')->get('index.raw_material'); ?>(<?php echo app('translator')->get('index.code'); ?>)</th>
                    <th class="w-15 text-left"><?php echo app('translator')->get('index.rate_per_unit'); ?></th>
                    ...
                    <?php $__currentLoopData = $m_rmaterials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="rowCount">
                            ...
                            <td class="text-start"><?php echo e($value->consumption); ?>
                                ...
                                <?php echo e(getPurchaseUnitByRMID($value->rmaterials_id)); ?>

                            </td>
                            <td class="text-right padding-0"><?php echo e(getAmtCustom($value->total_cost)); ?></td>
                        </tr>
            ...
            <tfoot>
                <tr>
                    <td colspan="4" class="text-right"><?php echo app('translator')->get('index.total_raw_material_cost'); ?> :</td>
                    <td class="text-right"><?php echo e(getAmtCustom($obj->mrmcost_total)); ?></td>
                </tr>
            </tfoot>
        </table>
        ...
        <table class="w-100 mt-10">
            <thead class="b-r-3 bg-color-000000">
                <tr>
                    <th class="w-5 text-left"><?php echo app('translator')->get('index.sn'); ?></th>
                    <th class="w-40 text-left"><?php echo app('translator')->get('index.non_inventory_items'); ?></th>
                    <th class="w-20 text-right"><?php echo app('translator')->get('index.non_inventory_cost'); ?></th>
                ...
                <?php if(isset($m_nonitems) && $m_nonitems): ?>
                    ...
                    <?php $__currentLoopData = $m_nonitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="rowCount">
                            ...
                            <td class="text-right padding-0"><?php echo e(getAmtCustom($value->nin_cost)); ?></td>
            ...
            <tfoot>
                <tr>
                    <td colspan="2" class="text-center"><?php echo app('translator')->get('index.total_non_inventory_cost'); ?> :</td>
                    <td class="text-right"><?php echo e(getAmtCustom($obj->mnoninitem_total)); ?></td>
                    <td></td>
                </tr>
            </tfoot>
        </table>
        ...
        <table class="w-100 mt-10">
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-center"><?php echo e(isset($total_days) && $total_days ? $total_days : ''); ?>
...
<?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\manufacture\print_manufacture_details.blade.php ENDPATH**/ ?>