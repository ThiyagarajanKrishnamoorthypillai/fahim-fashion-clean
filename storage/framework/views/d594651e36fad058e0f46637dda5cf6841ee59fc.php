                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="width_10_p"><?php echo app('translator')->get('index.total_cost'); ?></th>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(getCurrency($value->total_cost)); ?></td>
                                    <td><?php echo e(getCurrency($value->sale_price)); ?></td>
                                    ...
                                    <td class="ir_txt_center">
                                        ...
                                        <?php endif; ?>
                                        <?php if(routePermission('product.duplicate')): ?>
                                            <a href="<?php echo e(url('finishedproducts')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>"
                                        ...
                                        <?php endif; ?>
                                        <?php if(routePermission('product.delete')): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\finished_product\finishedproducts.blade.php ENDPATH**/ ?>