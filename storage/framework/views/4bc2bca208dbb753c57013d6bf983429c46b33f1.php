                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('index.product'); ?> (<?php echo app('translator')->get('index.code'); ?>)</th>
                                <th><?php echo app('translator')->get('index.cost'); ?></th>
                                <th><?php echo app('translator')->get('index.sale'); ?></th>
                                <th><?php echo app('translator')->get('index.profit_loss'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $pGrandTotal = 0; ?>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(getAmtCustom(getProductTotalCost($value->id))); ?></td>
                                    <td><?php echo e(getAmtCustom(getProductTotalSale($value->id))); ?></td>
                                    <td><?php echo e(getProfitLoss($value->id)); ?></td>
                                </tr>                                
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\report\product_profit_report.blade.php ENDPATH**/ ?>