...
<body>
    <div class="m-auto b-r-5 p-30">
        ...
        <div class="text-center pt-10 pb-10">
            <h2 class="color-000000 pt-20 pb-20"><?php echo app('translator')->get('index.supplier_payment_invoice'); ?></h2>
        </div>
        <table>
            <tr>
                <td class="w-50">
                    <h4 class="pb-7"><?php echo app('translator')->get('index.supplier_info'); ?>:</h4>
                    <p class="pb-7 arabic"><?php echo e($obj->supplierName->name); ?></p>
                    <p class="pb-7 rgb-71 arabic"><?php echo e($obj->supplierName->address); ?></p>
                    <p class="pb-7 rgb-71 arabic"><?php echo e($obj->supplierName->phone); ?></p>
                </td>
                <td class="w-50 text-right">
                    <h4 class="pb-7 arabic"><?php echo app('translator')->get('index.supplier_payment_info'); ?>:</h4>
                    <p class="pb-7">
        ...
        <table class="w-100 mt-20">
            <thead class="b-r-3 bg-color-000000">
                <tr>
                    ...
                    <th class="w-30 text-start arabic"><?php echo app('translator')->get('index.supplier'); ?></th>
            ...
            <tbody>
                ...
                <tr class="rowCount" data-id="<?php echo e($obj->id); ?>">
                    ...
                    <td class="text-start"><?php echo e(@$obj->supplierName->name); ?></td>
                ...
                <td class="w-50">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="w-50 text-right pr-0">
                                <p><?php echo e(getAmtCustom(getSupplierDue($obj->supplier))); ?></p>
                            </td>
                        </tr>
                    </table>                                        
                    <table>
...
<?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\supplier_payment\print_invoice.blade.php ENDPATH**/ ?>