                ...
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="w-15"><?php echo app('translator')->get('index.reference_no'); ?></th>
                            <th class="w-15"><?php echo app('translator')->get('index.date'); ?></th>
                            <th class="w-20"><?php echo app('translator')->get('index.supplier'); ?></th>
                            <th class="w-15"><?php echo app('translator')->get('index.g_total'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\report\rm_purchase_report.blade.php ENDPATH**/ ?>