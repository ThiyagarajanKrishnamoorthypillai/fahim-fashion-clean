...
<body>
    <div class="m-auto b-r-5 p-30">
        ...
        <div class="text-center pt-10 pb-10">
            <h2 class="color-000000 pt-20 pb-20"><?php echo app('translator')->get('index.estimate_cost_date'); ?></h2>
        </div>
        <table>
            <tr>
                <td class="w-50">
        ...
        <table class="w-100 mt-20">
            <thead class="b-r-3 bg-color-000000">
                <tr>
                    ...
                    <th class="w-5"><?php echo app('translator')->get('index.quantity'); ?></th>
                    <th class="w-45"><?php echo app('translator')->get('index.costing'); ?></th>
                    <th class="w-25"><?php echo app('translator')->get('index.required_time'); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php if(isset($productData) && $productData): ?>
                    <?php $__currentLoopData = $productData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="rowCount">
                            ...
                            <td><?php echo urldecode($value['cost']); ?></td>
                            <td class="text-center"><?php echo e($value['required_time']); ?>
...
<?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\stock\estimate_cost.blade.php ENDPATH**/ ?>