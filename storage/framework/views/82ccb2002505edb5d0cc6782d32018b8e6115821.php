                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(getTotalProductWaste($value->id)); ?></td>
                                    <td><?php echo e(safe($value->note)); ?></td>
                                    <td><?php echo e(getUserName($value->responsible_person)); ?></td>
                                    <td><?php echo e(getUserName($value->user_id)); ?></td>
                                    <td class="ir_txt_center">
                                        <?php if(routePermission('productwaste.edit')): ?>
                                            <a href="<?php echo e(url('product-wastes')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit"
                                        ...
                                        <?php endif; ?>
                                        <?php if(routePermission('productwaste.delete')): ?>
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="<?php echo e(route('product-wastes.destroy', $value->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\product_waste\index.blade.php ENDPATH**/ ?>