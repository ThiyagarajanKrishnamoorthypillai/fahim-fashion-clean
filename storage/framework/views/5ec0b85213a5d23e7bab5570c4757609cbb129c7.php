                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(getDateFormat($value->only_date)); ?></td>
                                    <td><?php echo e(@$value->customerName->name); ?></td>
                                    <td><?php echo e(getAmtCustom($value->amount)); ?></td>
                                    <td><?php echo e(safe($value->note)); ?></td>
                                    <td class="ir_txt_center">
										<a href="<?php echo e(route('customer-payment-download', encrypt_decrypt($value->id, 'encrypt'))); ?>"
                                        ...
                                        <?php if(routePermission('customer-received.edit')): ?>
                                            <a href="<?php echo e(url('customer-payment')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit"
                                        ...
                                        <?php endif; ?>
                                        <?php if(routePermission('customer-received.delete')): ?>
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="<?php echo e(route('customer-payment.destroy', $value->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\customer_payment\index.blade.php ENDPATH**/ ?>