...
unset($__errorArgs, $__bag); ?> select2 select2-hidden-accessible"
                                    ...
                                    <?php $__currentLoopData = $rmaterials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($rm->id . '|' . $rm->name . ' (' . $rm->code . ')|' . $rm->name . '|' . $rm->rate_per_unit . '|' . getPurchaseSaleUnitById($rm->unit) . '|' . $setting->currency); ?>">
                                            <?php echo e($rm->name . '(' . $rm->code . ')'); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\purchase\addEditPurchase.blade.php ENDPATH**/ ?>