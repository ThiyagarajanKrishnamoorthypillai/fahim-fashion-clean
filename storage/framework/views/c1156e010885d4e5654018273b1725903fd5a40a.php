                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select2-hidden-accessible" name="product_id"
                                    ...
                                    <?php $__currentLoopData = $finishProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <option value="<?php echo e($fp->id . '|' . $fp->name . ' (' . $fp->code . ')|' . $fp->name . '|' . productSalePrice($fp->id) . '|' . getPurchaseSaleUnitById($fp->unit) . '|' . $setting->currency . '|' . $fp->stock_method . '|' . $current_total_stock); ?>"><?php echo e($fp->name . '(' . $fp->code . ')'); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <div class="text-danger d-none"></div>
                            </div>
                            ...
                            <div class="row mb-1 ms-1">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="change_currency"
                                        name="change_currency" value="1" <?php echo e(isset($obj->converted_currency_id) ? 'checked' : ''); ?>>
                                    <label class="form-check-label" for="change_currency">
                                        <?php echo app('translator')->get('index.change_currency'); ?>
                                    </label>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\sales\addEditSale.blade.php ENDPATH**/ ?>