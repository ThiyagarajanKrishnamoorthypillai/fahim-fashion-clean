                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="width_26_p"><?php echo app('translator')->get('index.description'); ?></th>
                                <th class="width_13_p"><?php echo app('translator')->get('index.added_by'); ?></th>
                                <th class="width_13_p ir_txt_center"><?php echo app('translator')->get('index.actions'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="ir_txt_center">
                                        <?php if(routePermission('noi.edit')): ?>
                                            <a href="<?php echo e(url('noninventoryitems')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit"
                                        ...
                                        <?php endif; ?>
                                        <?php if(routePermission('noi.delete')): ?>
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="<?php echo e(route('noninventoryitems.destroy', $value->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\non_inventory_item\nonIItems.blade.php ENDPATH**/ ?>