...
<?php $__env->startSection('content'); ?>
    ...
    <section class="main-content-wrapper">
        ...
        <div class="box-wrapper">
            <?php echo e(Form::open(['route' => 'supplier-balance-report', 'id' => 'attendance_form', 'method' => 'get'])); ?>

            <div class="row">
                <div class="col-sm-12 mb-3 col-md-4 col-lg-2">
                    <div class="form-group">
                        <select class="form-control select2 op_width_100_p" id="type" name="type">
                            <option value="All" <?php echo e($type == 'All' ? 'selected="selected"' : ''); ?>><?php echo app('translator')->get('index.all'); ?>
                            </option>
                            <option value="Debit" <?php echo e($type == 'Debit' ? 'selected="selected"' : ''); ?>><?php echo app('translator')->get('index.debit'); ?>
                            </option>
                            <option value="Credit" <?php echo e($type == 'Credit' ? 'selected="selected"' : ''); ?>><?php echo app('translator')->get('index.credit'); ?>
                            </option>
                        </select>
                    </div>
                </div>
                                    ...
                                    <?php $__currentLoopData = $supplierDueReport; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($totalDue > 0): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left"><?php echo e(getAmtCustom(abs($totalDue))); ?> (<?php echo app('translator')->get('index.credit'); ?>)
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                    ...
                                    <?php $__currentLoopData = $supplierDueReport; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($totalDue < 0): ?>
                                            ...
                                            <tr>
                                                <td class="text-start"><?php echo e($i--); ?></td>
                                                <td class="text-left"><?php echo e($value->name); ?></td>
                                                <td class="text-left"><?php echo e(getAmtCustom(abs($totalDue))); ?>

                                                    (<?php echo app('translator')->get('index.debit'); ?>)</td>
                                            </tr>
                                        <?php endif; ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php elseif($totalDue > 0): ?>
                                                ...
                                                <td class="text-left"><?php echo e(getAmtCustom(abs($totalDue))); ?>
                                                    ...
                                                    (<?php echo app('translator')->get('index.credit'); ?>)</td>
                                            <?php else: ?>
                                                <td class="text-left"><?php echo e(getAmtCustom(abs($totalDue))); ?></td>
                                            <?php endif; ?>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\report\supplier_balance_report.blade.php ENDPATH**/ ?>