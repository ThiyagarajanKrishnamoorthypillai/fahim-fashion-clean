                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="width_10_p"><?php echo app('translator')->get('index.total_loss'); ?></th>
                                <th class="width_10_p"><?php echo app('translator')->get('index.raw_material_count'); ?></th>
                                <th class="width_10_p"><?php echo app('translator')->get('index.note'); ?></th>
                                <th class="width_10_p"><?php echo app('translator')->get('index.responsible_person'); ?></th>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(getCurrency($value->total_loss)); ?></td>
                                    <td><?php echo e(getTotalWaste($value->id)); ?></td>
                                    <td><?php echo e($value->note); ?></td>
                                    <td><?php echo e(getUserName($value->responsible_person)); ?></td>
                                    <td><?php echo e(getUserName($value->added_by)); ?></td>
                                    <td class="ir_txt_center">
                                        <?php if(routePermission('rmwaste.edit')): ?>
                                            <a href="<?php echo e(url('rmwastes')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit"
                                        ...
                                        <?php endif; ?>
                                        <?php if(routePermission('rmwaste.delete')): ?>
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="<?php echo e(route('rmwastes.destroy', $value->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\rmwaste\rmwastes.blade.php ENDPATH**/ ?>