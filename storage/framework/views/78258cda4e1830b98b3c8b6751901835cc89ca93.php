                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(@$value->supplierName->name); ?></td>
                                    <td><?php echo e(getAmtCustom($value->amount)); ?></td>
                                    <td><?php echo e(safe($value->note)); ?></td>
                                    <td class="ir_txt_center">
										<a href="<?php echo e(route('supplier-payment-download', encrypt_decrypt($value->id, 'encrypt'))); ?>"
                                        ...
                                        <?php if(routePermission('supplier-payment.edit')): ?>
                                            <a href="<?php echo e(url('supplier-payment')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit"
                                        ...
                                        <?php endif; ?>
                                        <?php if(routePermission('supplier-payment.delete')): ?>
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="<?php echo e(route('supplier-payment.destroy', $value->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\supplier_payment\index.blade.php ENDPATH**/ ?>