...
unset($__errorArgs, $__bag); ?> select2" name="product"
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php echo e(encrypt_decrypt(request()->get('product'), 'decrypt') == $value->id ? 'selected' : ''); ?> value="<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>"><?php echo e($value->name); ?>(<?php echo e($value->code); ?>)</option>
                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="w-15"><?php echo app('translator')->get('index.customer'); ?></th>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = productPriceHistory($value->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $i = $loop->iteration;
                                ?>
                                <tr>
                                    ...
                                    <td><?php echo e(getDateFormat($history->sale->sale_date)); ?></td>
                                    <td><?php echo e(getCustomerNameById($history->sale->customer_id)); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\finished_product\priceHistory.blade.php ENDPATH**/ ?>