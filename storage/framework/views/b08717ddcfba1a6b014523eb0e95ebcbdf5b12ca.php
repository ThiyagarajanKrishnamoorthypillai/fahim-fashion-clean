...
<?php $__env->startSection('content'); ?>
    <section class="main-content-wrapper">
        ...
        <div class="box-wrapper">
            ...
            <div class="table-box">
                <!-- form start -->
                <?php echo e(Form::open(['route' => 'product-wastes.store', 'id' => 'purchase_form', 'method' => 'post'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\product_waste\create.blade.php ENDPATH**/ ?>