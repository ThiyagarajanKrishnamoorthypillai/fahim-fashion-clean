...
<section class="main-content-wrapper">
    ...
    <div class="box-wrapper">
        <?php echo e(Form::open(['route'=>'rmwaste-report', 'id' => "expense_form", 'method'=>'get'])); ?>
                ...
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="op_width_10_p"><?php echo app('translator')->get('index.loss_amount'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo e(getAmtCustom($value->total_loss)); ?></td>
                                </tr>
                        <?php
                            }
                        }
                    ...
                    <tfoot>
                        <tr>
                            <th></th>
                            <th></th>
                            <th class="text-end"><?php echo app('translator')->get('index.total_loss'); ?>=</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\report\productwaste_report.blade.php ENDPATH**/ ?>