                        ...
                        <div class="m-auto b-r-5">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="w-50 text-right">
                                        <h4 class="pb-7"><?php echo app('translator')->get('index.supplier_payment_info'); ?>:</h4>
                                        <p class="pb-7">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\supplier_payment\invoice.blade.php ENDPATH**/ ?>