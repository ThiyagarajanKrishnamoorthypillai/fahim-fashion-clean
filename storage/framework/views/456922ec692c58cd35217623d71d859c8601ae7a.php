                                    ...
                                    <table class="w-100 mt-10">
                                        <thead class="b-r-3 bg-color-000000">
                                            <tr>
                                                ...
                                                <th class="w-15 text-center"><?php echo app('translator')->get('index.quantity'); ?></th>
                                                <th class="w-15 text-center"><?php echo app('translator')->get('index.delivery_date'); ?></th>
                                                <th class="w-15 text-center"><?php echo app('translator')->get('index.status'); ?></th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $orderDeliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr class="rowCount">
                                                    ...
                                                    <td class="text-center"><?php echo e(getDateFormat($value->delivery_date)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeSpace\Fahim-Fashion\resources\views\pages\customer_order\view.blade.php ENDPATH**/ ?>